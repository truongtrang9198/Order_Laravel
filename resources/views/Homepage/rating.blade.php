...
@section('main')
    ...
    <div class="container">
        <div class="row">
            <div class="col-xm-12 col-md-6">
                <div id="rating">
                    ...
                    <span id="">
                        &nbsp;
                        <button id="fa-frown" class="btn btn-rating" data-toggle="tooltip" data-placement="bottom"
                            title="Rất tệ">
                            <i class="far fa-frown" style="font-size:34px"></i></button> &nbsp;
                        <button id="fa-smile" class="btn btn-rating" data-toggle="tooltip" data-placement="bottom"
                            title="Bình thường thôi">
                            <i class="far fa-smile" style="font-size:34px"></i> </button> &nbsp;
                        <button id="fa-heart" class="btn btn-rating" data-toggle="tooltip" data-placement="bottom"
                            title="Ngon tuyệt">
        ...
        <div class="card mb-3 ">
            ...
            $url .
            '" class="card-img" alt="..." style="padding-top:10px; padding-bottom:10px; "
...
<script>
    $(document).ready(function() {
        ...
        $('#fa-smile').click(function() {
            ...
            let mess =
                '<br><br><lord-icon src="https://cdn.lordicon.com/dzllstvg.json" trigger="loop" style="width:34px;height:34px"> </lord-icon>';
        ...
        $('#fa-heart').click(function() {
            ...
            let mess =
                '<br><br><lord-icon src="https://cdn.lordicon.com/pithnlch.json" trigger="loop" style="width:34px;height:34px"> </lord-icon>';
